package com.example.abhinav.portfolio.ui.work
...
class WorkFragment : Fragment() {
    ...
    private fun createItems() {
        addItem(
            "Harvesting Farmers Network", "Mobile Development Intern", "June 2019 - August 2019",
        ...
        addItem(
            "1LearnApp", "Mobile Development Intern", "June 2018 - August 2018",
        ...
        addItem(
            "Hewlett Packard Enterprise", "Android Intern", "June 2017 - July 2017",
        ...
        addItem(
            "HoopStop", "Product Management Intern", "June 2019 - July 2019",
        ...
        addItem(
            "CICS UMass Amherst", "Undergraduate Teaching Assistant", "January 2020 - May 2020",
        ...
        addItem(
            "UMass Amherst", "Math Paper Grader", "September 2018 - May 2020",
        ...
        addItem(
            "UMass Amherst", "Soccer Referee", "March 2018 - November 2018",
            arrayOf("- Officiated matches for competitive intramural tournament to ensure games are played fairly and safely"),
            R.drawable.umass_icon
        )
    }

    private fun addItem(title: String, role: String, dates: String, subItems: Array<String>, iconRes: Int) {
        ...
        if (item != null) {
            ...
            for (i in 0 until item.subItemsCount) {
                ...
                if(i == 0) {
                    (view.findViewById(R.id.role) as TextView).text = role
